{# Validation config #}
{%- macro get_validation_config__sample_expressions_source() -%}

    {% set dbt_identifier = 'sample_expressions_source' %}
    ...
    {% set old_identifier = audit_helper_ext.get_old_identifier_name('sample_expressions_source') %}
...
{# Row count #}
{%- macro validation_count__sample_expressions_source() %}

    {% set validation_config = get_validation_config__sample_expressions_source() %}
    {% if execute %}
...
{%- macro validation_schema__sample_expressions_source() -%}
...
{# Column comparison #}
{%- macro validation_all_col__sample_expressions_source(summarize=true) -%}
...
{%- macro validation_full__sample_expressions_source(summarize=true) -%}
...
{# Validations for All #}
{%- macro validations__sample_expressions_source(summarize=true) -%}
...
{# Row count by group #}
{%- macro validation_count_by_group__sample_expressions_source(group_by) %}
...
{%- macro validation_col__sample_expressions_source(columns_to_compare, summarize=true, limit=100) -%}
