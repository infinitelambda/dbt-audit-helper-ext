{# Validation config #}
{%- macro get_validation_config__stores() -%}
    ...
    {% set old_identifier = audit_helper_ext.get_old_identifier_name('stores') %}
...
{%- macro validation_count__stores() %}
    ...
    {% set validation_config = get_validation_config__stores() %}
    {% if execute %}
...
{%- macro validation_schema__stores() -%}
