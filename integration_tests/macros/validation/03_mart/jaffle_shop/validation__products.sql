{# Validation config #}
{%- macro get_validation_config__products() -%}
    ...
    {% set old_identifier = audit_helper_ext.get_old_identifier_name('products') %}
...
{%- macro validation_count__products() %}
    ...
    {% set validation_config = get_validation_config__products() %}
    {% if execute %}
...
{%- macro validation_schema__products() -%}
