{# Row count #}
{%- macro validation_count__sample_target_5() %}
...
{# Column comparison #}
{%- macro validation_all_col__sample_target_5(summarize=true) -%}
...
{# Full validation #}
{%- macro validation_full__sample_target_5(summarize=true) -%}
...
{# Validations for All #}
{%- macro validations__sample_target_5(summarize=true) -%}
